...
public class Main {
  ...
  public static void main(String args[]) throws IOException {
    ...
    String test1 = sc.readLine();
    int n = Integer.parseInt(test1);

    String test2 = sc.readLine();
    int m = Integer.parseInt(test2);

    String test3 = sc.readLine().split(" ");
    String test4 = sc.readLine().split(" ");
    ...
    String test5 = sc.readLine();
    int q = Integer.parseInt(test5);
    int[] arr3 = new int[q];
